...
public class Dummy1 extends BaseClass {
...
//		Assert.assertTrue(pmntpage.ThankyouMessage().equalsIgnoreCase("THANKYOU FOR THE ORDER."));
	...
	@Test
	public void exclude() {
		System.out.println("will exclude this particular tc excluded");
	}
	
	@Test
	public void include() {
		System.out.println("will excluded all other, will execute only one tc");
	}
}
